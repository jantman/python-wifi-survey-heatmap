# -*- coding: utf-8 -*-
#
# wifi-survey-heatmap documentation build configuration file, created by
...
from wifi_survey_heatmap.version import VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'wifi-survey-heatmapdoc'
...
latex_documents = [
  (master_doc, 'wifi-survey-heatmap.tex', u'wifi-survey-heatmap Documentation',
...
man_pages = [
    (master_doc, 'wifi-survey-heatmap', u'wifi-survey-heatmap Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'wifi-survey-heatmap', u'wifi-survey-heatmap Documentation',
   author, 'wifi-survey-heatmap', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/wifi-survey-heatmap'
]
